...
class ProcessThread(QThread):
    ...
    def start_timeout(self):
        from code.config import PROCESSING_TIMEOUT_SECONDS
    ...
    def handle_timeout(self):
        ...
        self.error.emit(self.translations.get('timeout_error', 'Processing timed out'))
        self.stop()
    ...
    def import_files(self):
        ...
        try:
            ...
            for file_path in files:
                ...
                if dst.exists():
                    # Optional: Ask to overwrite or skip? For now, let's overwrite or skip.
                    # Simple behavior: Overwrite
                    pass
            ...
            self.log_viewer.add_log('ERROR', f'Failed to import files: {e}')
